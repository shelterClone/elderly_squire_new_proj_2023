...
class SocialSafetyNets extends StatelessWidget {
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 10),
                              Text(
                                 "The social safety assistance shall\n"
                                 "include, but not be limited to, food\n"
                                 "medicines, and financial assistance\n"
                                 "for house repair to cushion effects\n"
                                 "of economic, disaster and calamity\n"
                                 "shocks.",
                                style: TextStyle(
                                  fontSize: 15,
                                  fontFamily: ('OpenSans'),
