...
class TaxExemption extends StatelessWidget {
                            ...
                            children: [
                              Container(
                                margin:EdgeInsets.only(bottom: 58),
                                  child: Icon(Icons.check_circle_rounded,color:Colors.lightGreen)),
                              SizedBox(width: 10),
                              Text(
                                "Exemption from payment of indivi\n"
                                 "dual income tax of those who are\n"
                                 "considered to be minimum wage\n"
                                  "earners.",
                                style: TextStyle(
                                  fontSize: 15,
                                  fontFamily: ('OpenSans'),
