...
//            ),
                  ...
                  Center(
                    child: Container(
                        margin:
                        EdgeInsets.only(left: 30, bottom: 20, right: 30),
                        child: Text(
                  ...
                  Center(
                    child: Container(
                        margin: EdgeInsets.only(left: 30, top: 10, bottom:20, right: 30),
                        child: Text(
                  ...
                  Container(
                      margin: EdgeInsets.only(
                          left: 30, top: 10, bottom: 20, right: 30),
                      child: Text(
                        'SECTION 1. Short Title. – This Act shall be known as the “Data Privacy Act of 2012”.', //--------------------------------------------------PRODUCTS----------------------------//
                        style: TextStyle(
                          fontSize: 15,
                          fontFamily: ('OpenSans'),
                        ),
